...
base_solvers = [
    {
        ...
        "params": {
            ...
            "output_interval": 1000,
            "value_initializer": "degree",
            "dataset": "er_large_bestbatch_90s",
            "time_limit": 90
        },
    },
    # # {
    ...
    {"name": "Gurobi", "class": GurobiMIS, "params": {"time_limit": 90,}},
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 90, "dataset": "er_large_bestbatch", "iteration": 200}},
