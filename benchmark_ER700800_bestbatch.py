...
base_solvers = [
    ...
    },
    {
        ...
        "params": {
            ...
            "checkpoints": [450] + list(range(4500, 225001, 4500)),
            "time_limit": 30,
            "dataset": "er_700-800_30sec_bestbatch", #er_700-800 #er_dense
        },
    },
    {"name": "Gurobi", "class": GurobiMIS, "params": {"time_limit": 30,}},
    {"name": "Gurobi_warm", "class": GurobiMIS_warm, "params": {"time_limit": 30, "dataset": "er_700-800_450step_bestbatch", "iteration": 450}},
]
